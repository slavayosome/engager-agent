...
export type AgentConfig = {
  ...
  mcpUrl: string;
  /** Dedicated unattended-runner key. Never register it in an interactive MCP client. */
  apiKey: string;
  /** Stored provenance lets upgrades reject legacy/general-purpose credentials. */
  ...
  /** Server-bound stable machine id. Missing identity forces device reauthorization. */
  runnerId: string;
};
